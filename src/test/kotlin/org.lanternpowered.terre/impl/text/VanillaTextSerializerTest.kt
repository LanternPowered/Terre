...
class VanillaTextSerializerTest {
  ...
  @Test fun `test colored and grouped text`() {
    val text = ("Part 1".toText().color(Colors.Red) + " and Part 2".toText()) as TextImpl
  ...
  @Test fun `test glyph text`() {
    val text = GlyphRegistry.require(0).toText() as TextImpl
  ...
  @Test fun `test translatable and grouped text`() {
    ...
    val text = (localized + " and Part 2".toText()) as TextImpl
  ...
  @Test fun `test translatable, grouped and colored text`() {
    ...
    val text = (localized + ", Part 1 ".toText().color(Colors.Lime) + " and Part 2".toText()) as TextImpl
  ...
  @Test fun `test literal with square brackets text 2`() {
    val text = "[Test] and another ] after".toText().color(Colors.Red) as TextImpl
