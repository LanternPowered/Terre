...
internal val Protocol194 = MultistateProtocol(194) {
  ...
  play {
    ...
    bind(0x75, PlayerHurtEncoder, PlayerHurtDecoder, PacketDirection.ClientToServer)
    bind(0x76, PlayerDeathEncoder, PlayerDeathDecoder, PacketDirection.ClientToServer)
